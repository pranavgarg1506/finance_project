...
## overriding the abbove atribute
#min_level = 'INFO'
...
LOGGING = {
    ...
    'formatters': {
        ...
        'dev_format' :{
            'format' : "%(asctime)s [%(threadName)-12.12s] %(levelname)s %(filename)s:%(lineno)d | %(funcName)s | %(message)s"
        },
    },
    'handlers': {
        'logfile': {
            ...
            'filename': os.path.join(BASE_DIR, 'online.log'),
